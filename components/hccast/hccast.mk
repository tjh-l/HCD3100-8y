...
HCCAST_DEPENDENCIES += kernel pthread hudi
...
ifeq ($(BR2_PACKAGE_HCCAST_DIAL),y)
HCCAST_CONF_OPTS += -DHCCAST_DIAL=ON
HCCAST_DEPENDENCIES += ffmpeg
endif

ifeq ($(BR2_PACKAGE_HCCAST_USBMIRROR),y)
HCCAST_DEPENDENCIES += libusb cjson
HCCAST_CONF_OPTS += -DHCCAST_UM=ON
endif

ifeq ($(BR2_PACKAGE_HCCAST_USBMIRROR_SLAVE),y)
HCCAST_CONF_OPTS += -DHCCAST_UM_SLAVE=ON
endif
...
HCCAST_CONF_OPTS += -DWIFI_SUPPORT=ON
HCCAST_CONF_OPTS += -DWIFI_RTL8723BS_SUPPORT=ON
endif
...
HCCAST_CONF_OPTS += -DWIFI_SUPPORT=ON
HCCAST_CONF_OPTS += -DWIFI_ECR6600U_SUPPORT=ON
endif

ifeq ($(BR2_PACKAGE_PREBUILTS_RTL8733BS),y)
HCCAST_CONF_OPTS += -DWIFI_SUPPORT=ON
HCCAST_CONF_OPTS += -DWIFI_RTL8733BS_SUPPORT=ON
endif

ifeq ($(BR2_PACKAGE_HCCAST_AIRP2P_SUPPORT),y)
HCCAST_CONF_OPTS += -DHCCAST_AIRP2P=ON
endif

ifeq ($(BR2_PACKAGE_LIBEV), y)
HCCAST_DEPENDENCIES += libev
endif
