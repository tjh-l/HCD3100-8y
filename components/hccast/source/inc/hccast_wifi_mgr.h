...
#define WEP_PASSWD_ASCII_LEN_5   5
#define WEP_PASSWD_ASCII_LEN_13  13
#define WEP_PASSWD_HEX_LEN_10    10
#define WEP_PASSWD_HEX_LEN_26    26
...
typedef enum _hccast_wifi_encrypt_mode_e_
{
    ...
    HCCAST_WIFI_ENCRYPT_MODE_NOT_HANDLE,
