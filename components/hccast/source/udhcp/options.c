...
/* add dns option to a packet */
int add_dns_option(unsigned char *optionptr, uint32_t* ips, int ips_len)
{
    ...
    option[OPT_LEN] = ips_len * sizeof(uint32_t);
    memcpy(option + 2, ips, option[OPT_LEN]);
