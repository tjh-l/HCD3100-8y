...
void setup_scr_prthome(lv_ui *ui)
{
	...
	lv_obj_set_size(ui->prthome, 1024, 600);
	...
	lv_obj_set_size(ui->prthome_cont0, 1024, 220);
	...
	lv_obj_set_pos(ui->prthome_cont3, 0, 220);
	lv_obj_set_size(ui->prthome_cont3, 1024, 379);
	...
	lv_obj_set_pos(ui->prthome_cont1, 85, 132);
	lv_obj_set_size(ui->prthome_cont1, 853, 308);
	...
	lv_obj_set_pos(ui->prthome_label4, 360, 35);
	lv_obj_set_size(ui->prthome_label4, 292, 66);
	...
	lv_obj_set_style_text_font(ui->prthome_label4, &lv_font_arial_34, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_imgbtn_set_src(ui->prthome_imgbtnit, LV_IMGBTN_STATE_RELEASED, NULL, &_btn4_alpha_245x308, NULL);
	lv_imgbtn_set_src(ui->prthome_imgbtnit, LV_IMGBTN_STATE_PRESSED, NULL, &_btn4_alpha_245x308, NULL);
	lv_imgbtn_set_src(ui->prthome_imgbtnit, LV_IMGBTN_STATE_CHECKED_RELEASED, NULL, &_btn4_alpha_245x308, NULL);
	lv_imgbtn_set_src(ui->prthome_imgbtnit, LV_IMGBTN_STATE_CHECKED_PRESSED, NULL, &_btn4_alpha_245x308, NULL);
	...
	lv_obj_set_pos(ui->prthome_imgbtnit, 693, 132);
	lv_obj_set_size(ui->prthome_imgbtnit, 245, 308);
	...
	lv_obj_set_style_text_font(ui->prthome_imgbtnit, &lv_font_arial_25, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->prthome_imgbtnit, &lv_font_arial_34, LV_PART_MAIN|LV_STATE_PRESSED);
	...
	lv_obj_set_style_text_font(ui->prthome_imgbtnit, &lv_font_arial_34, LV_PART_MAIN|LV_STATE_CHECKED);
	...
	lv_imgbtn_set_src(ui->prthome_imgbtnusb, LV_IMGBTN_STATE_RELEASED, NULL, &_btn2_alpha_245x308, NULL);
	lv_imgbtn_set_src(ui->prthome_imgbtnusb, LV_IMGBTN_STATE_PRESSED, NULL, &_btn2_alpha_245x308, NULL);
	lv_imgbtn_set_src(ui->prthome_imgbtnusb, LV_IMGBTN_STATE_CHECKED_RELEASED, NULL, &_btn2_alpha_245x308, NULL);
	lv_imgbtn_set_src(ui->prthome_imgbtnusb, LV_IMGBTN_STATE_CHECKED_PRESSED, NULL, &_btn2_alpha_245x308, NULL);
	...
	lv_obj_set_pos(ui->prthome_imgbtnusb, 85, 132);
	lv_obj_set_size(ui->prthome_imgbtnusb, 245, 308);
	...
	lv_obj_set_style_text_font(ui->prthome_imgbtnusb, &lv_font_arial_25, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->prthome_imgbtnusb, &lv_font_arial_34, LV_PART_MAIN|LV_STATE_PRESSED);
	...
	lv_obj_set_style_text_font(ui->prthome_imgbtnusb, &lv_font_arial_34, LV_PART_MAIN|LV_STATE_CHECKED);
	...
	lv_imgbtn_set_src(ui->prthome_imgbtnmobile, LV_IMGBTN_STATE_RELEASED, NULL, &_btn3_alpha_245x308, NULL);
	lv_imgbtn_set_src(ui->prthome_imgbtnmobile, LV_IMGBTN_STATE_PRESSED, NULL, &_btn3_alpha_245x308, NULL);
	lv_imgbtn_set_src(ui->prthome_imgbtnmobile, LV_IMGBTN_STATE_CHECKED_RELEASED, NULL, &_btn3_alpha_245x308, NULL);
	lv_imgbtn_set_src(ui->prthome_imgbtnmobile, LV_IMGBTN_STATE_CHECKED_PRESSED, NULL, &_btn3_alpha_245x308, NULL);
	...
	lv_obj_set_pos(ui->prthome_imgbtnmobile, 390, 132);
	lv_obj_set_size(ui->prthome_imgbtnmobile, 245, 308);
	...
	lv_obj_set_style_text_font(ui->prthome_imgbtnmobile, &lv_font_arial_25, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->prthome_imgbtnmobile, &lv_font_arial_34, LV_PART_MAIN|LV_STATE_PRESSED);
	...
	lv_obj_set_style_text_font(ui->prthome_imgbtnmobile, &lv_font_arial_34, LV_PART_MAIN|LV_STATE_CHECKED);
	...
	lv_obj_set_pos(ui->prthome_labelusb, 123, 352);
	lv_obj_set_size(ui->prthome_labelusb, 157, 44);
	...
	lv_obj_set_style_text_font(ui->prthome_labelusb, &lv_font_arial_34, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(ui->prthome_labelmobile, 422, 352);
	lv_obj_set_size(ui->prthome_labelmobile, 157, 44);
	...
	lv_obj_set_style_text_font(ui->prthome_labelmobile, &lv_font_arial_34, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(ui->prthome_labelit, 725, 352);
	lv_obj_set_size(ui->prthome_labelit, 181, 44);
	...
	lv_obj_set_style_text_font(ui->prthome_labelit, &lv_font_arial_34, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(ui->prthome_label2, 34, 480);
	lv_obj_set_size(ui->prthome_label2, 938, 66);
	...
	lv_obj_set_style_text_font(ui->prthome_label2, &lv_font_arial_34, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_img_set_src(ui->prthome_usb, &_usb_alpha_64x64);
	lv_img_set_pivot(ui->prthome_usb, 0,0);
	lv_img_set_angle(ui->prthome_usb, 0);
	lv_obj_set_pos(ui->prthome_usb, 213, 187);
	lv_obj_set_size(ui->prthome_usb, 64, 64);
	...
	lv_img_set_src(ui->prthome_mobile, &_mobile_alpha_64x64);
	lv_img_set_pivot(ui->prthome_mobile, 0,0);
	lv_img_set_angle(ui->prthome_mobile, 0);
	lv_obj_set_pos(ui->prthome_mobile, 516, 187);
	lv_obj_set_size(ui->prthome_mobile, 64, 64);
	...
	lv_img_set_src(ui->prthome_internet, &_internet_alpha_64x64);
	lv_img_set_pivot(ui->prthome_internet, 0,0);
	lv_img_set_angle(ui->prthome_internet, 0);
	lv_obj_set_pos(ui->prthome_internet, 817, 187);
	lv_obj_set_size(ui->prthome_internet, 64, 64);
	...
	lv_obj_set_pos(ui->prthome_btnprintback, 106, 28);
	lv_obj_set_size(ui->prthome_btnprintback, 64, 64);
	...
	lv_obj_set_style_radius(ui->prthome_btnprintback, 110, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->prthome_btnprintback, &lv_font_simsun_25, LV_PART_MAIN|LV_STATE_DEFAULT);
