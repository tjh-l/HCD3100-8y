...
void setup_scr_saved(lv_ui *ui)
{
	...
	lv_obj_set_size(ui->saved, 1024, 600);
	...
	lv_obj_set_size(ui->saved_cont0, 1024, 600);
	...
	lv_obj_set_pos(ui->saved_btnsavecontinue, 358, 430);
	lv_obj_set_size(ui->saved_btnsavecontinue, 298, 88);
	...
	lv_obj_set_style_radius(ui->saved_btnsavecontinue, 110, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->saved_btnsavecontinue, &lv_font_simsun_25, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(ui->saved_label2, 320, 352);
	lv_obj_set_size(ui->saved_label2, 384, 44);
	...
	lv_obj_set_style_text_font(ui->saved_label2, &lv_font_arial_34, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_img_set_src(ui->saved_img1, &_ready_alpha_213x213);
	lv_img_set_pivot(ui->saved_img1, 0,0);
	lv_img_set_angle(ui->saved_img1, 0);
	lv_obj_set_pos(ui->saved_img1, 394, 88);
	lv_obj_set_size(ui->saved_img1, 213, 213);
