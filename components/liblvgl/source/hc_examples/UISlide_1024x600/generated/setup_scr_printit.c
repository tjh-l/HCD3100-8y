...
void setup_scr_printit(lv_ui *ui)
{
	...
	lv_obj_set_size(ui->printit, 1024, 600);
	...
	lv_obj_set_size(ui->printit_cont0, 1024, 600);
	...
	lv_obj_set_pos(ui->printit_btnprtitback, 347, 419);
	lv_obj_set_size(ui->printit_btnprtitback, 285, 86);
	...
	lv_obj_set_style_radius(ui->printit_btnprtitback, 110, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->printit_btnprtitback, &lv_font_simsun_25, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(ui->printit_label2, 21, 322);
	lv_obj_set_size(ui->printit_label2, 981, 66);
	...
	lv_obj_set_style_text_font(ui->printit_label2, &lv_font_arial_34, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_img_set_src(ui->printit_printer, &_printer2_alpha_128x121);
	lv_img_set_pivot(ui->printit_printer, 0,0);
	lv_img_set_angle(ui->printit_printer, 0);
	lv_obj_set_pos(ui->printit_printer, 328, 154);
	lv_obj_set_size(ui->printit_printer, 128, 121);
	...
	lv_img_set_src(ui->printit_imgnotit, &_no_internet_alpha_53x53);
	lv_img_set_pivot(ui->printit_imgnotit, 0,0);
	lv_img_set_angle(ui->printit_imgnotit, 0);
	lv_obj_set_pos(ui->printit_imgnotit, 462, 136);
	lv_obj_set_size(ui->printit_imgnotit, 53, 53);
	...
	lv_img_set_src(ui->printit_cloud, &_cloud_alpha_117x88);
	lv_img_set_pivot(ui->printit_cloud, 0,0);
	lv_img_set_angle(ui->printit_cloud, 0);
	lv_obj_set_pos(ui->printit_cloud, 550, 66);
	lv_obj_set_size(ui->printit_cloud, 117, 88);
