...
void setup_scr_copyhome(lv_ui *ui)
{
	...
	lv_obj_set_size(ui->copyhome, 1024, 600);
	...
	lv_obj_set_size(ui->copyhome_cont1, 1024, 220);
	...
	lv_obj_set_pos(ui->copyhome_cont2, 0, 220);
	lv_obj_set_size(ui->copyhome_cont2, 1024, 379);
	...
	lv_obj_set_pos(ui->copyhome_label1, 290, 66);
	lv_obj_set_size(ui->copyhome_label1, 480, 44);
	...
	lv_obj_set_style_text_font(ui->copyhome_label1, &lv_font_arial_34, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_img_set_src(ui->copyhome_img3, &_example_alpha_640x379);
	lv_img_set_pivot(ui->copyhome_img3, 0,0);
	lv_img_set_angle(ui->copyhome_img3, 0);
	lv_obj_set_pos(ui->copyhome_img3, 57, 165);
	lv_obj_set_size(ui->copyhome_img3, 640, 379);
	...
	lv_obj_set_pos(ui->copyhome_cont4, 785, 176);
	lv_obj_set_size(ui->copyhome_cont4, 170, 286);
	...
	lv_obj_set_pos(ui->copyhome_btncopynext, 785, 487);
	lv_obj_set_size(ui->copyhome_btncopynext, 170, 88);
	...
	lv_obj_set_style_radius(ui->copyhome_btncopynext, 110, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->copyhome_btncopynext, &lv_font_simsun_25, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(ui->copyhome_sliderhue, 896, 253);
	lv_obj_set_size(ui->copyhome_sliderhue, 17, 176);
	...
	lv_obj_set_style_radius(ui->copyhome_sliderhue, 110, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_radius(ui->copyhome_sliderhue, 110, LV_PART_INDICATOR|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_radius(ui->copyhome_sliderhue, 110, LV_PART_KNOB|LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(ui->copyhome_sliderbright, 810, 253);
	lv_obj_set_size(ui->copyhome_sliderbright, 17, 176);
	...
	lv_obj_set_style_radius(ui->copyhome_sliderbright, 110, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_radius(ui->copyhome_sliderbright, 110, LV_PART_INDICATOR|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_radius(ui->copyhome_sliderbright, 110, LV_PART_KNOB|LV_STATE_DEFAULT);
	...
	lv_img_set_src(ui->copyhome_bright, &_bright_alpha_51x51);
	lv_img_set_pivot(ui->copyhome_bright, 0,0);
	lv_img_set_angle(ui->copyhome_bright, 0);
	lv_obj_set_pos(ui->copyhome_bright, 793, 180);
	lv_obj_set_size(ui->copyhome_bright, 51, 51);
	...
	lv_img_set_src(ui->copyhome_hue, &_hue_alpha_44x44);
	lv_img_set_pivot(ui->copyhome_hue, 0,0);
	lv_img_set_angle(ui->copyhome_hue, 0);
	lv_obj_set_pos(ui->copyhome_hue, 881, 183);
	lv_obj_set_size(ui->copyhome_hue, 44, 44);
	...
	lv_obj_set_pos(ui->copyhome_btncopyback, 106, 55);
	lv_obj_set_size(ui->copyhome_btncopyback, 64, 64);
	...
	lv_obj_set_style_radius(ui->copyhome_btncopyback, 110, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->copyhome_btncopyback, &lv_font_simsun_25, LV_PART_MAIN|LV_STATE_DEFAULT);
