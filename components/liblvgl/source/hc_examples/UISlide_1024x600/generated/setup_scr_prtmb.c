...
void setup_scr_prtmb(lv_ui *ui)
{
	...
	lv_obj_set_size(ui->prtmb, 1024, 600);
	...
	lv_obj_set_size(ui->prtmb_cont0, 1024, 600);
	...
	lv_obj_set_pos(ui->prtmb_btnback, 364, 432);
	lv_obj_set_size(ui->prtmb_btnback, 285, 86);
	...
	lv_obj_set_style_radius(ui->prtmb_btnback, 110, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->prtmb_btnback, &lv_font_simsun_25, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(ui->prtmb_label2, 21, 322);
	lv_obj_set_size(ui->prtmb_label2, 981, 66);
	...
	lv_obj_set_style_text_font(ui->prtmb_label2, &lv_font_arial_34, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_img_set_src(ui->prtmb_printer, &_printer2_alpha_128x121);
	lv_img_set_pivot(ui->prtmb_printer, 0,0);
	lv_img_set_angle(ui->prtmb_printer, 0);
	lv_obj_set_pos(ui->prtmb_printer, 328, 154);
	lv_obj_set_size(ui->prtmb_printer, 128, 121);
	...
	lv_img_set_src(ui->prtmb_img, &_wave_alpha_53x53);
	lv_img_set_pivot(ui->prtmb_img, 0,0);
	lv_img_set_angle(ui->prtmb_img, 0);
	lv_obj_set_pos(ui->prtmb_img, 501, 183);
	lv_obj_set_size(ui->prtmb_img, 53, 53);
	...
	lv_img_set_src(ui->prtmb_cloud, &_phone_alpha_96x121);
	lv_img_set_pivot(ui->prtmb_cloud, 0,0);
	lv_img_set_angle(ui->prtmb_cloud, 0);
	lv_obj_set_pos(ui->prtmb_cloud, 597, 158);
	lv_obj_set_size(ui->prtmb_cloud, 96, 121);
