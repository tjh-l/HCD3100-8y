...
void setup_scr_scanhome(lv_ui *ui)
{
	...
	lv_obj_set_size(ui->scanhome, 1280, 720);
	...
	lv_obj_set_size(ui->scanhome_cont0, 1280, 264);
	...
	lv_obj_set_pos(ui->scanhome_label1, 362, 79);
	lv_obj_set_size(ui->scanhome_label1, 600, 52);
	...
	lv_obj_set_style_text_font(ui->scanhome_label1, &lv_font_arial_40, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(ui->scanhome_cont2, 0, 264);
	lv_obj_set_size(ui->scanhome_cont2, 1280, 454);
	...
	lv_img_set_src(ui->scanhome_img3, &_example_alpha_800x454);
	lv_img_set_pivot(ui->scanhome_img3, 0,0);
	lv_img_set_angle(ui->scanhome_img3, 0);
	lv_obj_set_pos(ui->scanhome_img3, 71, 198);
	lv_obj_set_size(ui->scanhome_img3, 800, 454);
	...
	lv_obj_set_pos(ui->scanhome_cont4, 981, 211);
	lv_obj_set_size(ui->scanhome_cont4, 212, 343);
	...
	lv_obj_set_pos(ui->scanhome_btnscansave, 981, 584);
	lv_obj_set_size(ui->scanhome_btnscansave, 212, 105);
	...
	lv_obj_set_style_radius(ui->scanhome_btnscansave, 137, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->scanhome_btnscansave, &lv_font_simsun_30, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(ui->scanhome_sliderhue, 1120, 303);
	lv_obj_set_size(ui->scanhome_sliderhue, 21, 211);
	...
	lv_obj_set_style_radius(ui->scanhome_sliderhue, 137, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_radius(ui->scanhome_sliderhue, 137, LV_PART_INDICATOR|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_radius(ui->scanhome_sliderhue, 137, LV_PART_KNOB|LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(ui->scanhome_sliderbright, 1012, 303);
	lv_obj_set_size(ui->scanhome_sliderbright, 21, 211);
	...
	lv_obj_set_style_radius(ui->scanhome_sliderbright, 137, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_radius(ui->scanhome_sliderbright, 137, LV_PART_INDICATOR|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_radius(ui->scanhome_sliderbright, 137, LV_PART_KNOB|LV_STATE_DEFAULT);
	...
	lv_img_set_src(ui->scanhome_bright, &_bright_alpha_61x61);
	lv_img_set_pivot(ui->scanhome_bright, 0,0);
	lv_img_set_angle(ui->scanhome_bright, 0);
	lv_obj_set_pos(ui->scanhome_bright, 991, 216);
	lv_obj_set_size(ui->scanhome_bright, 61, 61);
	...
	lv_img_set_src(ui->scanhome_hue, &_hue_alpha_52x52);
	lv_img_set_pivot(ui->scanhome_hue, 0,0);
	lv_img_set_angle(ui->scanhome_hue, 0);
	lv_obj_set_pos(ui->scanhome_hue, 1101, 219);
	lv_obj_set_size(ui->scanhome_hue, 52, 52);
	...
	lv_obj_set_pos(ui->scanhome_btnscanback, 132, 66);
	lv_obj_set_size(ui->scanhome_btnscanback, 76, 76);
	...
	lv_obj_set_style_radius(ui->scanhome_btnscanback, 137, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->scanhome_btnscanback, &lv_font_simsun_30, LV_PART_MAIN|LV_STATE_DEFAULT);
