...
void setup_scr_loader(lv_ui *ui)
{
	...
	lv_obj_set_size(ui->loader, 1280, 720);
	...
	lv_obj_set_size(ui->loader_cont0, 1280, 720);
	...
	lv_obj_set_pos(ui->loader_loadarc, 480, 211);
	lv_obj_set_size(ui->loader_loadarc, 280, 280);
	...
	lv_obj_set_style_radius(ui->loader_loadarc, 16, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(ui->loader_loadlabel, 535, 330);
	lv_obj_set_size(ui->loader_loadlabel, 212, 52);
	...
	lv_obj_set_style_text_font(ui->loader_loadlabel, &lv_font_arial_40, LV_PART_MAIN|LV_STATE_DEFAULT);
