...
void setup_scr_home(lv_ui *ui)
{
	...
	lv_obj_set_size(ui->home, 1280, 720);
	...
	lv_img_set_src(ui->home_img_bg2, &_blue_bg_alpha_1280x312);
	lv_img_set_pivot(ui->home_img_bg2, 50,50);
	lv_img_set_angle(ui->home_img_bg2, 0);
	lv_obj_set_pos(ui->home_img_bg2, 0, 321);
	lv_obj_set_size(ui->home_img_bg2, 1280, 312);
	...
	lv_img_set_src(ui->home_img_bg3, &_blue_bg_alpha_1280x87);
	lv_img_set_pivot(ui->home_img_bg3, 50,50);
	lv_img_set_angle(ui->home_img_bg3, 0);
	lv_obj_set_pos(ui->home_img_bg3, 0, 633);
	lv_obj_set_size(ui->home_img_bg3, 1280, 87);
	...
	lv_obj_set_pos(ui->home_slide_cont, 45, 321);
	lv_obj_set_size(ui->home_slide_cont, 1200, 312);
	...
	lv_imgbtn_set_src(ui->home_imgbtn_2, LV_IMGBTN_STATE_RELEASED, NULL, &_btn4_alpha_226x264, NULL);
	lv_imgbtn_set_src(ui->home_imgbtn_2, LV_IMGBTN_STATE_PRESSED, NULL, &_btn4_alpha_226x264, NULL);
	lv_imgbtn_set_src(ui->home_imgbtn_2, LV_IMGBTN_STATE_CHECKED_RELEASED, NULL, &_btn4_alpha_226x264, NULL);
	lv_imgbtn_set_src(ui->home_imgbtn_2, LV_IMGBTN_STATE_CHECKED_PRESSED, NULL, &_btn4_alpha_226x264, NULL);
	...
	lv_obj_set_pos(ui->home_imgbtn_2, 1223, 25);
	lv_obj_set_size(ui->home_imgbtn_2, 226, 264);
	...
	lv_obj_set_style_text_font(ui->home_imgbtn_2, &lv_font_arial_30, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->home_imgbtn_2, &lv_font_arial_40, LV_PART_MAIN|LV_STATE_PRESSED);
	...
	lv_obj_set_style_text_font(ui->home_imgbtn_2, &lv_font_arial_40, LV_PART_MAIN|LV_STATE_CHECKED);
	...
	lv_obj_set_pos(ui->home_label_2, 1241, 193);
	lv_obj_set_size(ui->home_label_2, 200, 52);
	...
	lv_obj_set_style_text_font(ui->home_label_2, &lv_font_arial_40, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_img_set_src(ui->home_img_2, &_setup_alpha_73x73);
	lv_img_set_pivot(ui->home_img_2, 0,0);
	lv_img_set_angle(ui->home_img_2, 0);
	lv_obj_set_pos(ui->home_img_2, 1330, 80);
	lv_obj_set_size(ui->home_img_2, 73, 73);
	...
	lv_imgbtn_set_src(ui->home_imgbtn_6, LV_IMGBTN_STATE_RELEASED, NULL, &_btn4_alpha_226x264, NULL);
	lv_imgbtn_set_src(ui->home_imgbtn_6, LV_IMGBTN_STATE_PRESSED, NULL, &_btn4_alpha_226x264, NULL);
	lv_imgbtn_set_src(ui->home_imgbtn_6, LV_IMGBTN_STATE_CHECKED_RELEASED, NULL, &_btn4_alpha_226x264, NULL);
	lv_imgbtn_set_src(ui->home_imgbtn_6, LV_IMGBTN_STATE_CHECKED_PRESSED, NULL, &_btn4_alpha_226x264, NULL);
	...
	lv_obj_set_pos(ui->home_imgbtn_6, 2175, 25);
	lv_obj_set_size(ui->home_imgbtn_6, 226, 264);
	...
	lv_obj_set_style_text_font(ui->home_imgbtn_6, &lv_font_arial_30, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->home_imgbtn_6, &lv_font_arial_40, LV_PART_MAIN|LV_STATE_PRESSED);
	...
	lv_obj_set_style_text_font(ui->home_imgbtn_6, &lv_font_arial_40, LV_PART_MAIN|LV_STATE_CHECKED);
	...
	lv_img_set_src(ui->home_img_6, &_setup_alpha_73x73);
	lv_img_set_pivot(ui->home_img_6, 0,0);
	lv_img_set_angle(ui->home_img_6, 0);
	lv_obj_set_pos(ui->home_img_6, 2280, 88);
	lv_obj_set_size(ui->home_img_6, 73, 73);
	...
	lv_obj_set_pos(ui->home_label_6, 2203, 193);
	lv_obj_set_size(ui->home_label_6, 200, 52);
	...
	lv_obj_set_style_text_font(ui->home_label_6, &lv_font_arial_40, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_imgbtn_set_src(ui->home_imgbtn_5, LV_IMGBTN_STATE_RELEASED, NULL, &_btn3_alpha_226x264, NULL);
	lv_imgbtn_set_src(ui->home_imgbtn_5, LV_IMGBTN_STATE_PRESSED, NULL, &_btn3_alpha_226x264, NULL);
	lv_imgbtn_set_src(ui->home_imgbtn_5, LV_IMGBTN_STATE_CHECKED_RELEASED, NULL, &_btn3_alpha_226x264, NULL);
	lv_imgbtn_set_src(ui->home_imgbtn_5, LV_IMGBTN_STATE_CHECKED_PRESSED, NULL, &_btn3_alpha_226x264, NULL);
	...
	lv_obj_set_pos(ui->home_imgbtn_5, 1940, 25);
	lv_obj_set_size(ui->home_imgbtn_5, 226, 264);
	...
	lv_obj_set_style_text_font(ui->home_imgbtn_5, &lv_font_arial_30, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->home_imgbtn_5, &lv_font_arial_40, LV_PART_MAIN|LV_STATE_PRESSED);
	...
	lv_obj_set_style_text_font(ui->home_imgbtn_5, &lv_font_arial_40, LV_PART_MAIN|LV_STATE_CHECKED);
	...
	lv_imgbtn_set_src(ui->home_imgbtn_4, LV_IMGBTN_STATE_RELEASED, NULL, &_btn2_alpha_226x264, NULL);
	lv_imgbtn_set_src(ui->home_imgbtn_4, LV_IMGBTN_STATE_PRESSED, NULL, &_btn2_alpha_226x264, NULL);
	lv_imgbtn_set_src(ui->home_imgbtn_4, LV_IMGBTN_STATE_CHECKED_RELEASED, NULL, &_btn2_alpha_226x264, NULL);
	lv_imgbtn_set_src(ui->home_imgbtn_4, LV_IMGBTN_STATE_CHECKED_PRESSED, NULL, &_btn2_alpha_226x264, NULL);
	...
	lv_obj_set_pos(ui->home_imgbtn_4, 1701, 25);
	lv_obj_set_size(ui->home_imgbtn_4, 226, 264);
	...
	lv_obj_set_style_text_font(ui->home_imgbtn_4, &lv_font_arial_30, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->home_imgbtn_4, &lv_font_arial_40, LV_PART_MAIN|LV_STATE_PRESSED);
	...
	lv_obj_set_style_text_font(ui->home_imgbtn_4, &lv_font_arial_40, LV_PART_MAIN|LV_STATE_CHECKED);
	...
	lv_obj_set_pos(ui->home_label_5, 1970, 193);
	lv_obj_set_size(ui->home_label_5, 186, 52);
	...
	lv_obj_set_style_text_font(ui->home_label_5, &lv_font_arial_40, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(ui->home_label_4, 1758, 193);
	lv_obj_set_size(ui->home_label_4, 160, 52);
	...
	lv_obj_set_style_text_font(ui->home_label_4, &lv_font_arial_40, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_img_set_src(ui->home_img_4, &_scan_alpha_73x73);
	lv_img_set_pivot(ui->home_img_4, 0,0);
	lv_img_set_angle(ui->home_img_4, 0);
	lv_obj_set_pos(ui->home_img_4, 1801, 62);
	lv_obj_set_size(ui->home_img_4, 73, 73);
	...
	lv_imgbtn_set_src(ui->home_imgbtn_3, LV_IMGBTN_STATE_RELEASED, NULL, &_btn_bg_1_alpha_226x264, NULL);
	lv_imgbtn_set_src(ui->home_imgbtn_3, LV_IMGBTN_STATE_PRESSED, NULL, &_btn_bg_1_alpha_226x264, NULL);
	lv_imgbtn_set_src(ui->home_imgbtn_3, LV_IMGBTN_STATE_CHECKED_RELEASED, NULL, &_btn_bg_1_alpha_226x264, NULL);
	lv_imgbtn_set_src(ui->home_imgbtn_3, LV_IMGBTN_STATE_CHECKED_PRESSED, NULL, &_btn_bg_1_alpha_226x264, NULL);
	...
	lv_obj_set_pos(ui->home_imgbtn_3, 1462, 25);
	lv_obj_set_size(ui->home_imgbtn_3, 226, 264);
	...
	lv_obj_set_style_text_font(ui->home_imgbtn_3, &lv_font_arial_30, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->home_imgbtn_3, &lv_font_arial_40, LV_PART_MAIN|LV_STATE_PRESSED);
	...
	lv_obj_set_style_text_font(ui->home_imgbtn_3, &lv_font_arial_40, LV_PART_MAIN|LV_STATE_CHECKED);
	...
	lv_obj_set_pos(ui->home_label_3, 1503, 193);
	lv_obj_set_size(ui->home_label_3, 165, 52);
	...
	lv_obj_set_style_text_font(ui->home_label_3, &lv_font_arial_40, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_img_set_src(ui->home_img_3, &_copy_alpha_73x73);
	lv_img_set_pivot(ui->home_img_3, 0,0);
	lv_img_set_angle(ui->home_img_3, 0);
	lv_obj_set_pos(ui->home_img_3, 1578, 72);
	lv_obj_set_size(ui->home_img_3, 73, 73);
	...
	lv_imgbtn_set_src(ui->home_imgbtn_1, LV_IMGBTN_STATE_RELEASED, NULL, &_btn4_alpha_226x264, NULL);
	lv_imgbtn_set_src(ui->home_imgbtn_1, LV_IMGBTN_STATE_PRESSED, NULL, &_btn4_alpha_226x264, NULL);
	lv_imgbtn_set_src(ui->home_imgbtn_1, LV_IMGBTN_STATE_CHECKED_RELEASED, NULL, &_btn4_alpha_226x264, NULL);
	lv_imgbtn_set_src(ui->home_imgbtn_1, LV_IMGBTN_STATE_CHECKED_PRESSED, NULL, &_btn4_alpha_226x264, NULL);
	...
	lv_obj_set_pos(ui->home_imgbtn_1, 985, 25);
	lv_obj_set_size(ui->home_imgbtn_1, 226, 264);
	...
	lv_obj_set_style_text_font(ui->home_imgbtn_1, &lv_font_arial_30, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->home_imgbtn_1, &lv_font_arial_40, LV_PART_MAIN|LV_STATE_PRESSED);
	...
	lv_obj_set_style_text_font(ui->home_imgbtn_1, &lv_font_arial_40, LV_PART_MAIN|LV_STATE_CHECKED);
	...
	lv_imgbtn_set_src(ui->home_imgbtnscan, LV_IMGBTN_STATE_RELEASED, NULL, &_btn2_alpha_226x264, NULL);
	lv_imgbtn_set_src(ui->home_imgbtnscan, LV_IMGBTN_STATE_PRESSED, NULL, &_btn2_alpha_226x264, NULL);
	lv_imgbtn_set_src(ui->home_imgbtnscan, LV_IMGBTN_STATE_CHECKED_RELEASED, NULL, &_btn2_alpha_226x264, NULL);
	lv_imgbtn_set_src(ui->home_imgbtnscan, LV_IMGBTN_STATE_CHECKED_PRESSED, NULL, &_btn2_alpha_226x264, NULL);
	...
	lv_obj_set_pos(ui->home_imgbtnscan, 268, 25);
	lv_obj_set_size(ui->home_imgbtnscan, 226, 264);
	...
	lv_obj_set_style_text_font(ui->home_imgbtnscan, &lv_font_arial_30, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->home_imgbtnscan, &lv_font_arial_40, LV_PART_MAIN|LV_STATE_PRESSED);
	...
	lv_obj_set_style_text_font(ui->home_imgbtnscan, &lv_font_arial_40, LV_PART_MAIN|LV_STATE_CHECKED);
	...
	lv_imgbtn_set_src(ui->home_imgbtnset, LV_IMGBTN_STATE_RELEASED, NULL, &_btn4_alpha_226x264, NULL);
	lv_imgbtn_set_src(ui->home_imgbtnset, LV_IMGBTN_STATE_PRESSED, NULL, &_btn4_alpha_226x264, NULL);
	lv_imgbtn_set_src(ui->home_imgbtnset, LV_IMGBTN_STATE_CHECKED_RELEASED, NULL, &_btn4_alpha_226x264, NULL);
	lv_imgbtn_set_src(ui->home_imgbtnset, LV_IMGBTN_STATE_CHECKED_PRESSED, NULL, &_btn4_alpha_226x264, NULL);
	...
	lv_obj_set_pos(ui->home_imgbtnset, 746, 25);
	lv_obj_set_size(ui->home_imgbtnset, 226, 264);
	...
	lv_obj_set_style_text_font(ui->home_imgbtnset, &lv_font_arial_30, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->home_imgbtnset, &lv_font_arial_40, LV_PART_MAIN|LV_STATE_PRESSED);
	...
	lv_obj_set_style_text_font(ui->home_imgbtnset, &lv_font_arial_40, LV_PART_MAIN|LV_STATE_CHECKED);
	...
	lv_img_set_src(ui->home_img_1, &_setup_alpha_76x72);
	lv_img_set_pivot(ui->home_img_1, 0,0);
	lv_img_set_angle(ui->home_img_1, 0);
	lv_obj_set_pos(ui->home_img_1, 1095, 68);
	lv_obj_set_size(ui->home_img_1, 76, 72);
	...
	lv_obj_set_pos(ui->home_label_1, 1016, 193);
	lv_obj_set_size(ui->home_label_1, 200, 52);
	...
	lv_obj_set_style_text_font(ui->home_label_1, &lv_font_arial_40, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_imgbtn_set_src(ui->home_imgbtncopy, LV_IMGBTN_STATE_RELEASED, NULL, &_btn_bg_1_alpha_226x264, NULL);
	lv_imgbtn_set_src(ui->home_imgbtncopy, LV_IMGBTN_STATE_PRESSED, NULL, &_btn_bg_1_alpha_226x264, NULL);
	lv_imgbtn_set_src(ui->home_imgbtncopy, LV_IMGBTN_STATE_CHECKED_RELEASED, NULL, &_btn_bg_1_alpha_226x264, NULL);
	lv_imgbtn_set_src(ui->home_imgbtncopy, LV_IMGBTN_STATE_CHECKED_PRESSED, NULL, &_btn_bg_1_alpha_226x264, NULL);
	...
	lv_obj_set_pos(ui->home_imgbtncopy, 30, 25);
	lv_obj_set_size(ui->home_imgbtncopy, 226, 264);
	...
	lv_obj_set_style_text_font(ui->home_imgbtncopy, &lv_font_arial_30, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->home_imgbtncopy, &lv_font_arial_40, LV_PART_MAIN|LV_STATE_PRESSED);
	...
	lv_obj_set_style_text_font(ui->home_imgbtncopy, &lv_font_arial_40, LV_PART_MAIN|LV_STATE_CHECKED);
	...
	lv_imgbtn_set_src(ui->home_imgbtnprt, LV_IMGBTN_STATE_RELEASED, NULL, &_btn3_alpha_226x264, NULL);
	lv_imgbtn_set_src(ui->home_imgbtnprt, LV_IMGBTN_STATE_PRESSED, NULL, &_btn3_alpha_226x264, NULL);
	lv_imgbtn_set_src(ui->home_imgbtnprt, LV_IMGBTN_STATE_CHECKED_RELEASED, NULL, &_btn3_alpha_226x264, NULL);
	lv_imgbtn_set_src(ui->home_imgbtnprt, LV_IMGBTN_STATE_CHECKED_PRESSED, NULL, &_btn3_alpha_226x264, NULL);
	...
	lv_obj_set_pos(ui->home_imgbtnprt, 507, 25);
	lv_obj_set_size(ui->home_imgbtnprt, 226, 264);
	...
	lv_obj_set_style_text_font(ui->home_imgbtnprt, &lv_font_arial_30, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->home_imgbtnprt, &lv_font_arial_40, LV_PART_MAIN|LV_STATE_PRESSED);
	...
	lv_obj_set_style_text_font(ui->home_imgbtnprt, &lv_font_arial_40, LV_PART_MAIN|LV_STATE_CHECKED);
	...
	lv_img_set_src(ui->home_imgset, &_setup_alpha_73x73);
	lv_img_set_pivot(ui->home_imgset, 0,0);
	lv_img_set_angle(ui->home_imgset, 0);
	lv_obj_set_pos(ui->home_imgset, 868, 61);
	lv_obj_set_size(ui->home_imgset, 73, 73);
	...
	lv_img_set_src(ui->home_imgcopy, &_copy_alpha_73x73);
	lv_img_set_pivot(ui->home_imgcopy, 0,0);
	lv_img_set_angle(ui->home_imgcopy, 0);
	lv_obj_set_pos(ui->home_imgcopy, 133, 73);
	lv_obj_set_size(ui->home_imgcopy, 73, 73);
	...
	lv_obj_set_pos(ui->home_labelcopy, 53, 193);
	lv_obj_set_size(ui->home_labelcopy, 165, 52);
	...
	lv_obj_set_style_text_font(ui->home_labelcopy, &lv_font_arial_40, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_img_set_src(ui->home_imgscan, &_scan_alpha_73x73);
	lv_img_set_pivot(ui->home_imgscan, 0,0);
	lv_img_set_angle(ui->home_imgscan, 0);
	lv_obj_set_pos(ui->home_imgscan, 376, 75);
	lv_obj_set_size(ui->home_imgscan, 73, 73);
	...
	lv_obj_set_pos(ui->home_labelscan, 296, 193);
	lv_obj_set_size(ui->home_labelscan, 160, 52);
	...
	lv_obj_set_style_text_font(ui->home_labelscan, &lv_font_arial_40, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_img_set_src(ui->home_imgprt, &_print_alpha_73x73);
	lv_img_set_pivot(ui->home_imgprt, 0,0);
	lv_img_set_angle(ui->home_imgprt, 0);
	lv_obj_set_pos(ui->home_imgprt, 623, 69);
	lv_obj_set_size(ui->home_imgprt, 73, 73);
	...
	lv_obj_set_pos(ui->home_labelprt, 543, 193);
	lv_obj_set_size(ui->home_labelprt, 186, 52);
	...
	lv_obj_set_style_text_font(ui->home_labelprt, &lv_font_arial_40, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(ui->home_labelset, 770, 193);
	lv_obj_set_size(ui->home_labelset, 200, 52);
	...
	lv_obj_set_style_text_font(ui->home_labelset, &lv_font_arial_40, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_img_set_src(ui->home_img_5, &_print_alpha_73x73);
	lv_img_set_pivot(ui->home_img_5, 0,0);
	lv_img_set_angle(ui->home_img_5, 0);
	lv_obj_set_pos(ui->home_img_5, 2057, 70);
	lv_obj_set_size(ui->home_img_5, 73, 73);
	...
	lv_obj_set_size(ui->home_cont1, 1280, 264);
	...
	lv_obj_set_pos(ui->home_labeldate, 640, 79);
	lv_obj_set_size(ui->home_labeldate, 600, 48);
	...
	lv_obj_set_style_text_font(ui->home_labeldate, &lv_font_arial_40, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_img_set_src(ui->home_pc, &_pc_alpha_52x52);
	lv_img_set_pivot(ui->home_pc, 0,0);
	lv_img_set_angle(ui->home_pc, 0);
	lv_obj_set_pos(ui->home_pc, 527, 79);
	lv_obj_set_size(ui->home_pc, 52, 52);
	...
	lv_img_set_src(ui->home_eco, &_eco_alpha_52x52);
	lv_img_set_pivot(ui->home_eco, 0,0);
	lv_img_set_angle(ui->home_eco, 0);
	lv_obj_set_pos(ui->home_eco, 391, 79);
	lv_obj_set_size(ui->home_eco, 52, 52);
	...
	lv_img_set_src(ui->home_wifi, &_wifi_alpha_76x49);
	lv_img_set_pivot(ui->home_wifi, 0,0);
	lv_img_set_angle(ui->home_wifi, 0);
	lv_obj_set_pos(ui->home_wifi, 148, 81);
	lv_obj_set_size(ui->home_wifi, 76, 49);
	...
	lv_img_set_src(ui->home_tel, &_tel_alpha_52x52);
	lv_img_set_pivot(ui->home_tel, 0,0);
	lv_img_set_angle(ui->home_tel, 0);
	lv_obj_set_pos(ui->home_tel, 280, 79);
	lv_obj_set_size(ui->home_tel, 52, 52);
	...
	lv_obj_set_pos(ui->home_sw_img_bg, 1155, 171);
	lv_obj_set_size(ui->home_sw_img_bg, 105, 42);
	...
	lv_obj_set_style_radius(ui->home_sw_img_bg, 12, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_radius(ui->home_sw_img_bg, 125, LV_PART_KNOB|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_bg_color(ui->home_sw_img_bg, lv_color_hex(0xffffff), LV_PART_KNOB|LV_STATE_FOCUSED);
	lv_obj_set_style_border_width(ui->home_sw_img_bg, 0, LV_PART_KNOB|LV_STATE_FOCUSED);
	lv_obj_set_style_radius(ui->home_sw_img_bg, 125, LV_PART_KNOB|LV_STATE_FOCUSED);
	...
	lv_obj_set_pos(ui->home_sw_img_bg_label, 876, 166);
	lv_obj_set_size(ui->home_sw_img_bg_label, 282, 61);
	...
	lv_obj_set_style_text_font(ui->home_sw_img_bg_label, &lv_font_montserratMedium_40, LV_PART_MAIN|LV_STATE_DEFAULT);
