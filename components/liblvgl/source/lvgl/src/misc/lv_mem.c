 ...
 */
LV_ATTRIBUTE_FAST_MEM void  __attribute__((weak)) lv_memset(void * dst, uint8_t v, size_t len)
{
 ...
 * @param len number of byte to set
 */
LV_ATTRIBUTE_FAST_MEM void __attribute__((weak)) lv_memset_00(void * dst, size_t len)
{
    uint8_t * d8 = (uint8_t *)dst;
    uintptr_t d_align = (lv_uintptr_t) d8 & ALIGN_MASK;
 ...
 * @param len number of byte to set
 */
LV_ATTRIBUTE_FAST_MEM void __attribute__((weak)) lv_memset_ff(void * dst, size_t len)
{
    uint8_t * d8 = (uint8_t *)dst;
    uintptr_t d_align = (lv_uintptr_t) d8 & ALIGN_MASK;
