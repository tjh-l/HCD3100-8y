...
LIBLVGL_BUILD_CMDS = rsync -au --chmod=u=rwX,go=rX  --exclude .svn --exclude .git --exclude ./Makefile --exclude .hg --exclude .bzr \
		     --exclude CVS $(TOPDIR)/components/liblvgl/source/ $(@D) && \
		     echo "silentoldconfig:">$(@D)/Makefile && \
		     if [ ! -f $(@D)/.config ];then \
