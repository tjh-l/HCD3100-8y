...
static int png_decode_idat(AVCodecContext *avctx, PNGDecContext *s, int length,
                             ...
                             uint32_t length, AVFrame *p)
{
    ...
    ret = png_decode_idat(avctx, s, length, p->data[0], p->linesize[0]);
