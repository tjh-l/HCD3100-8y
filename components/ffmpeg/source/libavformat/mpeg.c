...
static const AVOption mpegps_options[] = {
    { "pes_err", "Whether the time is being calculated", offsetof(MpegDemuxContext, pes_err), AV_OPT_TYPE_INT, { .i64 = 0 }, 0, INT_MAX, AV_OPT_FLAG_DECODING_PARAM },
    { NULL },
};

static const AVClass mpegps_class = {
    .class_name = "mpegps demuxer",
    .item_name  = av_default_item_name,
    .option     = mpegps_options,
