...
typedef struct MOVDiffIndexEntry {
    uint64_t diff_pos:28;        /* max 256 MBytes */
    uint64_t diff_dts:12;        /* max 4095 ms */
    uint64_t size:22;            /* max 4 MBytes */
    uint64_t flags:2;
} MOVDiffIndexEntry;
...
typedef struct MOVStreamContext {
    ...
    MOVDiffIndexEntry *diff_index_entries;
    int nb_diff_index_entries;
    AVIndexEntry *index_entries;
    int nb_index_entries;
    AVIndexEntry tmp_index;
    int isdash;
} MOVStreamContext;
