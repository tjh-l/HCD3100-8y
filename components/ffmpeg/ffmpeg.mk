...
FFMPEG_DEPENDENCIES += kernel pthread

include components/ffmpeg/ffmpeg.mk.plugins
#include $(sort $(wildcard components/ffmpeg/plugins))
...
ifeq ($(BR2_PACKAGE_WOLFSSL)$(CONFIG_NET),yy)
FFMPEG_CONF_OPTS += --enable-openssl
FFMPEG_DEPENDENCIES += wolfssl
else
FFMPEG_CONF_OPTS += --disable-openssl
endif
endif
...
FFMPEG_CONF_OPTS += --extra-libs=-lssp
FFMPEG_DEPENDENCIES += libssp
endif
