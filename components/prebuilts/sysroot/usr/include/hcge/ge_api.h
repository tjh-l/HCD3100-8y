...
typedef enum {
	...
	HCGE_DSBLIT_BLEND_ALPHACHANNEL     = 0x00000001, /* enables blending and uses alphachannel from source */
	HCGE_DSBLIT_BLEND_COLORALPHA       = 0x00000002, /* enables blending and uses alpha value from color */
	HCGE_DSBLIT_COLORIZE               = 0x00000004, /* modulates source color with the color's r/g/b values */
	...
	HCGE_DSBLIT_ROTATE                 = 0x00008000, /* rotate the image by any degree */
	...
	HCGE_DSBLIT_SRC_MASK_COLOR         = 0x00200000, /* Not supported at present. modulate source color channels with color channels
							    from source mask, see also IDirectFBSurface::SetSourceMask() */
...
typedef enum {
	HCGE_BLEND_DFB,
	HCGE_BLEND_ALPHA,
	HCGE_BLEND_SOURCE_BYPASS,
	HCGE_BLEND_PATTERN_BYPASS,
	HCGE_BLEND_BOOL_OPT_ENABLE,
	HCGE_BLEND_BOOL_OPT_ENABLE_NO_ALPHA,
...
typedef enum {
	...
	/* 32 bit   BGR (4 byte, nothing @24, red 8@16, green 8@8, blue 8@0) */
	HCGE_DSPF_BGR32    = HCGE_SURFACE_PIXELFORMAT( 30, 0, 0, 0, 0, 4, 0, 0, 0, 0, 0 ),
...
void hcge_state_init(hcge_state *state);
