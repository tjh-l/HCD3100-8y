...
#ifdef __linux__
#define AUM_UPG_URL "http://172.16.12.81/hccast/linux/%s/hcusbcast/HCFOTA.json"
#else
#define AUM_UPG_URL "http://172.16.12.81/hccast/rtos/%s/hcusbcast/HCFOTA.json"
#endif
