...
static int win_upgrade_close(void *arg)
{
    ...
    if (m_upg_type == MSG_TYPE_NET_UPGRADE)
    {
...
static win_ctl_result_t win_upgrade_status_update(uint32_t status)
{
    ...
    case UPG_STATUS_BURN_START:
        ...
        lv_obj_add_flag(m_upg_bar, LV_OBJ_FLAG_HIDDEN);
    #endif    
    ...
    case UPG_STATUS_BURN_FAIL:
    	lv_label_set_text(m_label_upg_msg, "Flash burn fail!");
    	//win_upgrade_exit = 0;
    	break;
    default:
    	break;
