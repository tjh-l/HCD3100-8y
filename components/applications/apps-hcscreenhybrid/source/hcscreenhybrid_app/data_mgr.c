...
static void data_mgr_default_init(void)
{
    ...
    m_app_data.airp2p_mode_switch = 2; //default auto.
...
int data_mgr_cast_um_full_screen_get(void)
{
    return m_app_data.um_full_screen;
}

void data_mgr_cast_um_full_screen_set(int enable)
{
