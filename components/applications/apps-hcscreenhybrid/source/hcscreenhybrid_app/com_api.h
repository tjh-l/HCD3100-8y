...
typedef enum{
    ...
    MSG_TYPE_CAST_AUSB_DEV_ADD,
    MSG_TYPE_CAST_AUSB_DEV_REMOVE,
    ...
    MSG_TYPE_CAST_IUSB_DEV_REMOVE, //apple usb mirror need user to trust
    MSG_TYPE_CAST_IUSB_START_UPGRADE,
    ...
    MSG_TYPE_AIRP2P_READY,
    MSG_TYPE_KEY_TRIGER_REBOOT,
