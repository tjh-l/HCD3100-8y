...
static int api_set_backlight_brightness(backlight_type_e type, unsigned int val)
{
	int lvds_fd;
...
#if defined(CONFIG_BOOT_SYSDATA_SET_BACKLIGHT_VALUE)
		sys_get_sysdata_lcd_pwm_backlight((uint8_t *)&backlight_value);
