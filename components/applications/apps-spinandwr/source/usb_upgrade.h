...
#define USBD_UPG_OUT_00_DDR_FLAG		0x20000001
#define USBD_UPG_OUT_01_DDR_DATA		0x20000002
#define	USBD_UPG_OUT_02_FRM_FLAG		0x20000004
#define USBD_UPG_OUT_03_FRM_DATA		0x20000008
#define	USBD_UPG_OUT_04_BRN_FLAG		0x20000010
#define USBD_UPG_OUT_05_RST_FLAG		0x20000020
#define	USBD_UPG_OUT_06_WAIT			0x20000040
#define USBD_UPG_OUT_07_FINISH			0X20000080

#define USBD_UPG_IN_00_DDR_DATA			0x10000001
#define	USBD_UPG_IN_01_FRM_DATA			0x10000002
#define USBD_UPG_IN_02_BRN_STAT			0x10000004
#define USBD_UPG_IN_03_RST_STAT			0x10000008
...
typedef struct usbDevRequest {
	...
	void (*reqComplete)(void *musb, struct usbDevRequest *pReq);
...
typedef struct usbMusbDcdDevice {
	...
	unsigned char ucTmpData[4];

	UpgHeaderFlag gslIDLHeadFlag;

	unsigned char *pMSCInterface_RK;
	unsigned char *pMSCDeviceDescriptor_RK;
} usbMusbDcdDevice_t;
