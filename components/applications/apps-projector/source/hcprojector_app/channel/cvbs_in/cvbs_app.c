...
lv_obj_t* cvbs_scr = NULL;
lv_group_t *cvbs_g = NULL;
...
static void cvbs_event_handle(lv_event_t* e){
    ...
    if(code == LV_EVENT_SCREEN_LOAD_START){
        ...
        //cvbs_rx_stop(); // don't stop when setup/source menu enter.
        lv_obj_clean(cvbs_scr);
...
void cvbs_screen_init(void)
{
    ...
    lv_obj_set_style_bg_color(cvbs_scr, lv_color_hex(0x0000ff), LV_PART_MAIN);
