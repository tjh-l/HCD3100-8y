...
void ui_fspage_screen_init(void)
{
    ...
    fspage_entry.control = mp_fs_message_ctrl;
...
void ui_ebook_screen_init(void)
{
    ...
    ctrl_bar_entry.screen = ui_ebook_txt;
    ctrl_bar_entry.control = media_playbar_control;
    api_screen_regist_ctrl_handle(&ctrl_bar_entry);
}
///////////////////// SCREENS ////////////////////
...
LV_IMG_DECLARE(public_movie);
LV_IMG_DECLARE(public_music);
LV_IMG_DECLARE(public_photo);
LV_IMG_DECLARE(public_text);
...
lv_obj_t * create_storage_icon(lv_obj_t * p)
{
	...
	lv_obj_set_size(mp_statebar, lv_pct(35), lv_pct(12));
	lv_obj_set_style_bg_opa(mp_statebar, LV_OPA_0, 0);
	lv_obj_align(mp_statebar, LV_ALIGN_TOP_RIGHT, 238, 0);
	lv_obj_set_style_pad_all(mp_statebar, 0, 0);
	lv_obj_set_style_border_width(mp_statebar, 0, 0);
	lv_obj_set_scrollbar_mode(mp_statebar, LV_SCROLLBAR_MODE_OFF);
    
    lv_obj_t *ui_usb_show = lv_obj_create(mp_statebar);
    lv_obj_set_size(ui_usb_show,LV_PCT(33),LV_PCT(100));
    lv_obj_set_pos(ui_usb_show,20,-2);
    lv_obj_t *ui_img2 = lv_img_create(ui_usb_show);
    lv_img_set_src(ui_img2, &public_usb_no);
    lv_obj_set_scrollbar_mode(ui_usb_show, LV_SCROLLBAR_MODE_OFF);
    lv_obj_set_style_bg_opa(ui_usb_show, LV_OPA_0, 0);
    lv_obj_set_style_border_width(ui_usb_show, 0, 0);	
    ...
    if(partition_info2 != NULL){
        if(partition_info2->count==0){
            lv_img_set_src(ui_img2, &public_usb_no);
        }else if(partition_info2->count==1){
            for(int i=0;i<partition_info2->count;i++){
                ...
                if(strstr(dev_name,"sd") || strstr(dev_name,"hd")||strstr(dev_name,"usb")){
                    lv_img_set_src(ui_img2, &public_usb);
                }else{
                    lv_img_set_src(ui_img2, &public_usb_no);
                }
                // if(strstr(dev_name,"mmc")){
                //     lv_img_set_src(ui_img2, &public_tf);
                // }
            }
...
{
    int color[] = {0x43B7FA, 0xA203ED, 0xFB6913, 0x05BF50};
	int string[] = {STR_MOVIE, STR_MUSIC, STR_PHOTO, STR_TEXT};
    void * imgs[] = {&public_movie, &public_music, &public_photo,  &public_text};

    for(int i = 0; i <SCR_MAINICON_NUM;i++){
        lv_obj_t* obj=lv_btn_create(p);
	    lv_obj_remove_style(obj, NULL, LV_STATE_DEFAULT);
	    lv_obj_set_size(obj, 237, 462);  
	    lv_obj_set_pos(obj, 151+247*i, 33);
	    lv_obj_clear_flag(obj, LV_OBJ_FLAG_SCROLLABLE);    
	    lv_obj_set_style_radius(obj, 16, LV_PART_MAIN | LV_STATE_DEFAULT); 
	    lv_obj_set_style_border_width(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);  
	    lv_obj_set_style_bg_color(obj, lv_color_hex(color[i]), LV_STATE_DEFAULT);  
	    lv_obj_set_style_bg_opa(obj, 255, LV_STATE_DEFAULT);  
        //lv_obj_set_style_bg_img_src(obj, imgs[i],0);

        lv_obj_set_style_text_color(obj, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
        //lv_obj_set_style_text_opa(obj, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
        //lv_obj_set_style_text_color(obj, lv_color_hex(0xFFFF00), LV_PART_MAIN | LV_STATE_FOCUS_KEY);
        //lv_obj_set_style_text_opa(obj, 255, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
        
        lv_obj_set_style_outline_color(obj, lv_color_hex(0xffffff), LV_PART_MAIN | LV_STATE_FOCUS_KEY);
        ...
        //lv_obj_set_style_border_color(obj, lv_color_hex(0xffffff), LV_STATE_FOCUS_KEY);
        //lv_obj_set_style_border_width(obj, 5, LV_STATE_FOCUS_KEY);
        //lv_obj_set_style_border_opa(obj, 255, LV_STATE_FOCUS_KEY);

        lv_obj_set_flex_flow(obj, LV_FLEX_FLOW_COLUMN);
        lv_obj_set_flex_align(obj, LV_FLEX_ALIGN_CENTER, LV_FLEX_ALIGN_CENTER, LV_FLEX_ALIGN_CENTER);
        lv_obj_set_style_pad_row(obj, 26, 0);

	    lv_obj_add_event_cb(obj,main_page_keyinput_event_cb,LV_EVENT_ALL,0);


		lv_obj_t* img =lv_img_create(obj);
        lv_img_set_src(img, imgs[i]);
        lv_obj_set_scrollbar_mode(obj, LV_SCROLLBAR_MODE_OFF);
		//lv_obj_align(label, LV_ALIGN_BOTTOM_MID,0,-128);
		
		lv_obj_t* label =lv_label_create(obj);
		//lv_obj_align(label, LV_ALIGN_BOTTOM_MID,0,-128);
		set_label_text2(label, string[i],FONT_LARGE);
...
static lv_obj_t* create_obj_cont(lv_obj_t* p)
{
	...
	lv_obj_align(cont1,LV_ALIGN_BOTTOM_MID,0,0);
    lv_obj_set_size(cont1,LV_PCT(100),LV_PCT(88));
    ...
    //lv_obj_set_style_flex_flow(cont1,LV_FLEX_FLOW_ROW,0);
...
int create_ctrlbarpage_scr(lv_obj_t *p,lv_event_cb_t cb_func)
{
    ...
    set_label_text2(lv_obj_get_child(ctrlbarbtn[3],0),STR_VIDEO_PREV,FONT_MID); 
    set_label_text2(lv_obj_get_child(ctrlbarbtn[4],0),STR_VIDEO_NEXT,FONT_MID); 
...
int create_ctrlbar_in_video(lv_obj_t *parent)
{
    ...
    for(int i=14;i<MAX_BARBTN_ITEM;i++){
        lv_obj_del(ctrlbarbtn[i]);
    }

}

void label_set_with_ImageEffect(lv_obj_t* p)
{
    mpimage_effect_t*  mpimage_effect=(mpimage_effect_t*)mpimage_effect_info_get();
    switch(mpimage_effect->type){
        ...
        case EFFECT_FADE: 
            ...
            break; 
        case EFFECT_MOSAIC: 
            set_label_text2(lv_obj_get_child(p,0),STR_MOSAIC_EFFECT,FONT_MID);    
            break; 
        default :
            break;
    }    
...
int create_ctrlbar_in_photo(lv_obj_t * parent)
{
    ...
    lv_obj_set_style_bg_img_src(ctrlbarbtn[15],&IDB_Hint_CaptureLogo,0);
    ...
    set_label_text2(lv_obj_get_child(ctrlbarbtn[3],0),STR_PHOTO_PREV,FONT_MID); 
    set_label_text2(lv_obj_get_child(ctrlbarbtn[4],0),STR_PHOTO_NEXT,FONT_MID); 
    set_label_text2(lv_obj_get_child(ctrlbarbtn[7],0),STR_INFO,FONT_MID); 
    set_label_text2(lv_obj_get_child(ctrlbarbtn[8],0),STR_LIST,FONT_MID); 
    set_label_text2(lv_obj_get_child(ctrlbarbtn[9],0),STR_ZOOMIN,FONT_MID); 
    set_label_text2(lv_obj_get_child(ctrlbarbtn[10],0),STR_ZOOMOUT,FONT_MID); 
    ...
    set_label_text2(lv_obj_get_child(ctrlbarbtn[14],0),STR_MUSIC_SRC,FONT_MID); 
    label_set_with_ImageEffect(ctrlbarbtn[14]);
    set_label_text2(lv_obj_get_child(ctrlbarbtn[15],0),ctrl_bar_get_img_dis_str_id(),FONT_MID); 
    ctrlbar_zoomfunction_btn_update();
    lv_obj_add_state(ctrlbarbtn[11],LV_STATE_DISABLED);

#ifndef IMAGE_DISPLAY_MODE_SUPPORT
    for(int i=15;i<MAX_BARBTN_ITEM;i++){
        lv_obj_del(ctrlbarbtn[i]);
    }
#endif
    return 0;
...
int create_ctrlbar_in_music(lv_obj_t * parent)
{
    ...
    set_label_text2(lv_obj_get_child(ctrlbarbtn[3],0),STR_MUSIC_PREV,FONT_MID); 
    set_label_text2(lv_obj_get_child(ctrlbarbtn[4],0),STR_MUSIC_NEXT,FONT_MID); 
