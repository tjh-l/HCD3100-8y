...
#ifdef BR2_PACKAGE_PREBUILTS_WPA_SUPPLICANT
#define BOARDTEST_WIFI_SUPPORT
#endif

#ifdef BR2_PACKAGE_CJSON
#define BOARDTEST_CJSON_SUPPORT
#endif

#ifdef CONFIG_NET
#define BOARDTEST_NET_SUPPORT
#endif
...
#define EBOOK_FILE_SIZE_MAX 30*1024*1024    //30M ebook preview size
