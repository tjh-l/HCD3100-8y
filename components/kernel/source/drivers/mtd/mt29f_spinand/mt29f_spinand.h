...
#define CMD_PROG_PAGE_RANDOM		0x84
...
#define REG_F0H_STATUS			0xf0/* timing */
#define REG_A0H_STATUS			0xa0/* timing */
...
/* quad mode read/write */
#define QUAD_MODE_MASK	0x01
...
struct spinand_cmd {
	...
	u8		*rx_buf;	/* Rx buf */
	u8		rx_width;	/* Number of rx width */
	u8		tx_width;	/* Number of tx width */
};
