#ifndef _RN6752_INITABLE_CVBS_NTSC_H_
#define _RN6752_INITABLE_CVBS_NTSC_H_

#include "../dvp.h"



struct regval_list RN675_init_cfg_cvbs_ntsc[] = {
