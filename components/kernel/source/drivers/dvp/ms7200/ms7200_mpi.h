...
#define MS7200_LOG(X)       mculib_uart_log((UINT8*)X)
#define MS7200_LOG1(X, Y)   mculib_uart_log1((UINT8*)X, Y)
#define MS7200_LOG2(X, Y)   mculib_uart_log2((UINT8*)X, Y)
