...
/************HYN_GESTURE_EN********************/
#if HYN_GESTURE_EN
extern int hyn_gesture_init(struct input_dev *input_dev, struct hynitron_ts_data *client);
...
/************HYN_ESDCHECK_EN********************/
#if HYN_ESDCHECK_EN
extern void hyn_create_esd_sysfs(struct hynitron_ts_data *client);
...
extern int hyn_create_sysfs(struct hynitron_ts_data *client);
extern void hyn_release_sysfs(struct hynitron_ts_data *client);
#endif
