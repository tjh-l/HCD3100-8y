...
/*
 * WDT clocks source default:
 * 	15xx:clocksF27M_CLK(Crystal clock,27 MHz)
 * 	16xx:clocksF24M_CLK(Crystal clock,24 MHz)
...
#define usec2tick(usec) ((usec)*24 / 32)
#define tick2usec(tick) ((tick)*32 / 24)
#endif
