...
#define SKBUF_FLAG_IS_HCLONE 0x04U
#define SKBUF_FLAG_IS_DRIVER_ALLOC 0x08U
...
struct sk_buff {
	...
	sk_buff_free_custom_fn	hclone_free_function;
	void			*hclone_free_opaque;
	void			*priv;
