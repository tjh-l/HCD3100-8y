...
#define MIPI_DSI_SET_DCS_INIT_SEQUENCE			_IOW (MIPI_IOCBASE, 13, struct hc_dcs_cmds)		//<! change init-sequence
...
#define MIPI_DSI_CLOCK_LANE_NP_SWAP	(1UL << (0))		/* mipi clock lane np swap */
#define MIPI_DSI_DATA0_LANE_NP_SWAP	(1UL << (1))		/* mipi data0 lane np swap */
#define MIPI_DSI_DATA1_LANE_NP_SWAP	(1UL << (2))		/* mipi data1 lane np swap */
#define MIPI_DSI_DATA2_LANE_NP_SWAP	(1UL << (3))		/* mipi data2 lane np swap */
#define MIPI_DSI_DATA3_LANE_NP_SWAP	(1UL << (4))		/* mipi data3 lane np swap */
...
typedef enum MIPI_DRIVE_STRENGTH_E_
{
	MIPI_DRIVE_STRENGTH_MIDIMUN,
	MIPI_DRIVE_STRENGTH_MIDDLE,
	MIPI_DRIVE_STRENGTH_BIGGER, //default
	MIPI_DRIVE_STRENGTH_MAXIMUM,
}mipi_drive_strength_e;
...
struct mipi_display_timing
{
	...
	unsigned int dsi_flags;
	mipi_drive_strength_e drive_strength;
	unsigned int swap_flags;
};
