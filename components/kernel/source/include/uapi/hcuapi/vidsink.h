...
struct vframe_info {
	...
	dis_type_e dis_type;   //!< dis_type_e
	dis_layer_e dis_layer; //!< dis_layer_e
};

struct vframe_display_info {
	dis_type_e dis_type;   //!< dis_type_e
	dis_layer_e dis_layer; //!< dis_layer_e
};
...
#define VIDSINK_DISABLE_IMG_EFFECT2	_IOW(VIDSINK_IOCBASE, 2, struct vframe_display_info)
