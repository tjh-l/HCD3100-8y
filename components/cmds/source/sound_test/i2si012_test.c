...
static int i2si012_test(int argc, char *argv[])
{
...
static int stop_i2si012_test(int argc, char *argv[])
{
	stop_i2si012 = 1;
	return 0;
}

CONSOLE_CMD(i2si012, "snd", i2si012_test, CONSOLE_CMD_MODE_SELF, "do i2si0/i2si1/i2si2 test")
CONSOLE_CMD(stop_i2si012, "snd", stop_i2si012_test, CONSOLE_CMD_MODE_SELF, "stop i2si test")
