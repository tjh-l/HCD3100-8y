...
static int i2s_rec_play_test(int argc, char *argv[])
{
    int ret;
...
CONSOLE_CMD(stop_i2s_rec_play, "snd", stop_i2s_rec_play_test, CONSOLE_CMD_MODE_SELF, "stop i2s rec play test")
CONSOLE_CMD(i2s_rec_play, "snd", i2s_rec_play_test, CONSOLE_CMD_MODE_SELF, "do i2s rec play test")
