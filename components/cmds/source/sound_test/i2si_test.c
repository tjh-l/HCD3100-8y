...
static int i2si_test(int argc, char *argv[])
{
    int ret;
...
static int stop_i2si_test(int argc, char *argv[])
{
	stop_i2si = 1;
	return 0;
}
...
static int wm8960_test(int argc, char *argv[])
{
	uint8_t res = 0;
	int fd = 0;
...
CONSOLE_CMD(i2si, "snd", i2si_test, CONSOLE_CMD_MODE_SELF, "do i2si test")
CONSOLE_CMD(stop_i2si, "snd", stop_i2si_test, CONSOLE_CMD_MODE_SELF, "stop i2si test")
CONSOLE_CMD(wm8960, "snd", wm8960_test, CONSOLE_CMD_MODE_SELF, "before doing i2si test,need to do wm8960_test")
