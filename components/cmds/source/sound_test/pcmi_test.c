...
static int pcmi_test(int argc, char *argv[])
{
...
static int stop_pcmi_test(int argc, char *argv[])
{
	stop_pcmi012 = 1;
	return 0;
}

CONSOLE_CMD(pcmi, "snd", pcmi_test, CONSOLE_CMD_MODE_SELF, "do pcmi0/pcmi1/pcmi2 test")
CONSOLE_CMD(stop_pcmi, "snd", stop_pcmi_test, CONSOLE_CMD_MODE_SELF, "stop pcmi0/pcmi1/pcmi2 test")
