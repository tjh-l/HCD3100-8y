...
static int stop_i2si_spectrum_test(int argc, char *argv[])
{
	(void)argc;
	(void)argv;
...
static int stop_i2so_spectrum_test(int argc, char *argv[])
{
	(void)argc;
	(void)argv;
...
static int i2si_spectrum_test(int argc, char *argv[])
{
...
static int i2so_spectrum_test(int argc, char *argv[])
{
...
CONSOLE_CMD(i2so_spectrum, "snd", i2so_spectrum_test, CONSOLE_CMD_MODE_SELF, "do i2so_spectrum test")
CONSOLE_CMD(i2si_spectrum, "snd", i2si_spectrum_test, CONSOLE_CMD_MODE_SELF, "do i2si_spectrum test")
CONSOLE_CMD(stop_spectrum_i2si, "snd", stop_i2si_spectrum_test, CONSOLE_CMD_MODE_SELF, "stop i2si spectrum test")
CONSOLE_CMD(stop_spectrum_i2so, "snd", stop_i2so_spectrum_test, CONSOLE_CMD_MODE_SELF, "stop i2so spectrum test")
