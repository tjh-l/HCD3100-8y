 ...
 *
 *****************************************************************************/
#ifndef __RTW_PRIV_H__
#define __RTW_PRIV_H__
...
#define RTWPRIVE_VERSION "V5.8.0_20220302"
...
#define RTW_MEMSET(src,val,size) memset((void*)src,val,size)
#define RTW_MEMCPY(src,dst,size) memcpy((void*)src,(void*)dst,size)
#define RTW_FPRINT(xx, fmt, ...) printf(fmt, ##__VA_ARGS__) 
#define rtw_strerror(x) "ERROR"
